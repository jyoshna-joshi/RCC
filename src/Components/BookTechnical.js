    ...
    render() {
        return (<Form>
            ...
            <Form.Group className="mb-3" controlId="bookTechnicalPublisher">
                ...
                <Form.Control required  type="text" placeholder="Enter publisher name or organisation name" />
            </Form.Group>
            {/* for identifier*/}
            <Form.Group className="mb-3" controlId="bookTechnicalIdentifier">
                <Form.Label>Identifier</Form.Label>
                <Form.Control required  type="text" placeholder="Enter publication identifier" />
            </Form.Group>
            {/* for description*/}
            ...
            <Form.Group className="mb-3" controlId="bookTechnicalCreator">
                ...
                <Form.Control required  type="text" placeholder="Enter author name list  or organisation name  " />
            </Form.Group>
            {/* for uploading file*/}

...
var CIcon = React.forwardRef(function (_a, ref) {
    ...
    var code = React.useMemo(function () {
        ...
        if (typeof _icon === 'string' && React__default["default"]['icons']) {
    ...
    return use ? (React__default["default"].createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", className: _className }, (height && { height: height }), (width && { width: width }), { role: "img" }, rest, { ref: ref }),
        React__default["default"].createElement("use", { href: use }))) : (React__default["default"].createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: viewBox, className: _className }, (height && { height: height }), (width && { width: width }), { role: "img", dangerouslySetInnerHTML: { __html: titleCode + iconCode } }, rest, { ref: ref })));
});
CIcon.propTypes = {
